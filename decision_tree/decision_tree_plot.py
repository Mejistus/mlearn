...
def createPlot(inTree):
    fig = plt.figure(1,dpi=100, facecolor='white')
    fig.clf()
...
def main():
    ...
    print(getTreeDepth.__name__, getTreeDepth(myTree))
    print(getNumLeafs.__name__, getNumLeafs(myTree))
    createPlot(myTree)
